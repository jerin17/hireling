...
$sql = "UPDATE jobs SET r_id='$r_id',j_time='$j_time', j_sal='$j_sal' ,j_location='$j_location',j_type='$j_type', j_description='$j_description' WHERE j_id='$j_id'" ;
...
<form action="r_postedit.php?id=<?php echo $j_id;?>" method="POST">
  ...
  <input type="text" name="j_type" size="52" value="<?php echo $row['j_type']; ?>" style="text-align: left;border:none;border-bottom: solid #A3D044 2px;" required>
  <label style="color: #A3D044;text-align: left;margin-left: 20px;margin-top: 20px;">DESCRIPTION :</label>
  <input type="text" name="j_description" size="52" value="<?php echo $row['j_description']; ?>" style="text-align: left;border:none;border-bottom: solid #A3D044 2px;">
  <label style="color: #A3D044;text-align: left;margin-left: 20px;margin-top: 20px;">SALARY :</label>
  <input type="text" name="j_sal" size="52" value="<?php echo $row['j_sal']; ?>" style="text-align: left;border:none;border-bottom: solid #A3D044 2px;" required>
  <label style="color: #A3D044;text-align: left;margin-left: 20px;margin-top: 20px;">LOCATION :</label>
  <input type="text" name="j_location" size="52" value="<?php echo $row['j_location']; ?>" style="text-align: left;border:none;border-bottom: solid #A3D044 2px;" required>
  <label style="color: #A3D044;text-align: left;margin-left: 20px;margin-top: 20px;">TIME :</label>
  <input type="text" name="j_time" size="52" value="<?php echo $row['j_time']; ?>" style="text-align: left;border:none;border-bottom: solid #A3D044 2px;" required>
