...
<div class="wrapper row2" style="background-image:url('images/demo/backgrounds/06.png');min-height: 575px">
...
20px;width: 300px;float: right;">
      <h3 style="background: #A3D044;padding: 10px;padding-left: 30px;margin: -20px;border-radius: 3px;margin-bottom: 10px;">Filter</h3>
<form action="new.php" method="post" style="text-align: center;">
